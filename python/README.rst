...
-  \ |TabTrader|\   **`TabTrader <https://tab-trader.com>`__** — trading on all exchanges in one app. Avaliable on `Android <https://play.google.com/store/apps/details?id=com.tabtrader.android&referrer=utm_source%3Dccxt>`__ and `iOS <https://itunes.apple.com/app/apple-store/id1095716562?mt=8>`__.
...
+----------------------+----------------------------------------------------------------------------------------------+-------+---------------------------------------------------------------------------------------------------+--------------------+
| bybit                | `Bybit <https://www.bybit.com>`__                                                            | \*    | `API <https://github.com/bybit-exchange/bybit-official-api-docs>`__                               |                    |
+----------------------+----------------------------------------------------------------------------------------------+-------+---------------------------------------------------------------------------------------------------+--------------------+
...
.. |TabTrader| image:: https://user-images.githubusercontent.com/1294454/66603550-170f5700-ebb5-11e9-920c-ca366dacd715.png
   :target: https://tab-trader.com
